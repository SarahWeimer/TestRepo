...
public class ClientsideSettings extends CommonSettings {
		 ...
		 */
		private static final String LOGGER_NAME = "Projectplan Web Client";
		...
		public static AdministrationServiceAsync getAdministration() {
			   ...
			   // Gab es bislang noch keine AdministrationService-Instanz, dann...
		    if (administration == null) {
		      // Zunächst instantiieren wir AdministrationService
		    	administration = GWT.create(AdministrationService.class);
		    }

		    // So, nun brauchen wir die AdministrationService nur noch zurückzugeben.
